...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $bar_code = $_POST['bar_code'];
    ...
    $sql = "INSERT INTO `items`(`name`, `category`, `cost_price`, `sale_price`, `gst`, `bar_code`, `user_id`) VALUES('$name', '$category', '$cost_price', '$sale_price', '$gst', '$bar_code', '$user_id')";
...
<div class="container d-flex flex-column justify-content-center align-items-center gap-5">
  ...
  <strong> </strong> User successfully created!.
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    <div class="row w-50">
        <div class="col">
            <form action="addItem.php" method="POST" class="w-75 mx-auto">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="category" class="form-control" id="csCategory">
                </div>
                <div class="mb-3">
                    <label for="cscost_price" class="form-label"><b>cost price</b></label>
                    <input type="text" name="cost_price" class="form-control" id="cscost_price">
                </div>
                <div class="mb-3">
                    <label for="cssale_price" class="form-label"><b>sale price</b></label>
                    <input type="text" name="sale_price" class="form-control" id="cssale_price">
                </div>
                <div class="mb-3">
                    <label for="csGST" class="form-label"><b>GST</b></label>
                    <input type="text" name="gst" class="form-control" id="csGST">
                </div>
                <div class="mb-3">
